...
<body>
    ...
    <div id="para">
        ...
        <h3>TIKKA REVIEW GIVING</h3>   
        <form method="post" action="T_TOD_GR_INSERT.php">
	...
	<br>
    <center><button onclick="window.location.href='T_TOD_TR.php'" type="button" id="btnn">CHECK REVIEW</button>
    <button onclick="window.location.href='T_TOD_MENU.php'" type="button" id="btnn">MENU</button>
