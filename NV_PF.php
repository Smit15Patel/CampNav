...
<body>
    ...
    <div id="para">
        ...
        <h3>Non-Veg Food</h3>
        <button onclick="window.location.href='NV_PF_MENU.php'" type="button" id="btnn">MENU</button><br><br>
        <button onclick="window.location.href='NV_PF_TR.php'" type="button" id="btnn">REVIEW</button><BR><BR>
