...
<body>
    ...
    <div id="para">
        ...
        <h3>CHAAP Food</h3>
        <button onclick="window.location.href='C_TOD_MENU.php'" type="button" id="btnn">MENU</button><br><br>
        <button onclick="window.location.href='C_TOD_TR.php'" type="button" id="btnn">REVIEW</button><BR><BR>
        <button onclick="window.location.href='C_TOD_GR.php'" type="button" id="btnn">GIVE REVIEW</button>
    </div>
	<br>
