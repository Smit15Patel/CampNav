...
<body>
    ...
    <div id="para">
        ...
        <h3>EGG Food</h3>
        <button onclick="window.location.href='E_PF_MENU.php'" type="button" id="btnn">MENU</button><br><br>
        <button onclick="window.location.href='E_PF_TR.php'" type="button" id="btnn">REVIEW</button><BR><BR>
        <button onclick="window.location.href='E_PF_GR.php'" type="button" id="btnn">GIVE REVIEW</button>
    </div>
	<br>
	<center><div id="btn"><button onclick="window.location.href='/../app/HOME/Features/food/PF/PF.php'" id="login">BACK</button></div></center>
