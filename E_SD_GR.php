...
<body>
    ...
    <div id="para">
        ...
        <form method="post" action="E_SD_GR_INSERT.php">
	...
	<br>
    <center><button onclick="window.location.href='E_SD_TR.php'" type="button" id="btnn">CHECK REVIEW</button>
    <button onclick="window.location.href='E_SD_MENU.php'" type="button" id="btnn">MENU</button>
