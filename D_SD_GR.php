...
<body>
    ...
    <div id="para">
        ...
        <h3>DOSA FOOD REVIEW GIVING</h3>   
        <form method="post" action="D_SD_GR_INSERT.php">
	...
	<br>
    <center><button onclick="window.location.href='D_SD_TR.php'" type="button" id="btnn">CHECK REVIEW</button>
    <button onclick="window.location.href='D_SD_MENU.php'" type="button" id="btnn">MENU</button>
