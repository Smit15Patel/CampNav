...
<body>
    ...
    <div id="para">
        ...
        <h3>CHAAP FOOD REVIEW GIVING</h3>   
        <form method="post" action="C_TOD_GR_INSERT.php">
	...
	<br>
    <center><button onclick="window.location.href='C_TOD_TR.php'" type="button" id="btnn">CHECK REVIEW</button>
    <button onclick="window.location.href='C_TOD_MENU.php'" type="button" id="btnn">MENU</button>
    <div id="btn"><button onclick="window.location.href='/../app/HOME/Features/food/TOD/TOD.php'" id="login">BACK</button></div></center>
