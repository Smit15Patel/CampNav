...
<body>
    ...
    <div id="para">
        ...
        <h3>DOSA Food</h3>
        <button onclick="window.location.href='D_SD_MENU.php'" type="button" id="btnn">MENU</button><br><br>
        <button onclick="window.location.href='D_SD_TR.php'" type="button" id="btnn">REVIEW</button><BR><BR>
        <button onclick="window.location.href='D_SD_GR.php'" type="button" id="btnn">GIVE REVIEW</button>
    </div>
	<br>
