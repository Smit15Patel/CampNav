...
<body>
    ...
    <div id="para">
        ...
        <form method="post" action="V_TOD_GR_INSERT.php">
	...
	<br>
    <center><button onclick="window.location.href='V_TOD_TR.php'" type="button" id="btnn">CHECK REVIEW</button>
    <button onclick="window.location.href='V_TOD_MENU.php'" type="button" id="btnn">MENU</button>
