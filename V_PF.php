...
<body>
    ...
    <div id="para">
        ...
        <h3>Veg Food</h3>
        <button onclick="window.location.href='V_PF_MENU.php'" type="button" id="btnn">MENU</button><br><br>
        <button onclick="window.location.href='V_PF_TR.php'" type="button" id="btnn">REVIEW</button><BR><BR>
