...
<body>
    ...
    <div id="para">
        ...
        <h3>TIKKA Food</h3>
        <button onclick="window.location.href='T_TOD_MENU.php'" type="button" id="btnn">MENU</button><br><br>
        <button onclick="window.location.href='T_TOD_TR.php'" type="button" id="btnn">REVIEW</button><BR><BR>
        <button onclick="window.location.href='T_TOD_GR.php'" type="button" id="btnn">GIVE REVIEW</button>
    </div>
	<br>
	<center><div id="btn"><button onclick="window.location.href='/../app/HOME/Features/food/TOD/TOD.php'" id="login">BACK</button></div></center>
